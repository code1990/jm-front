...
export default {
  ...
  data() {
    return {
      ...
      marker1:require('../../assets/sb_1.png'),
      marker2:require('../../assets/zm_1.png'),
  ...
  methods: {
    ...
    //   },
      ...
      for (let index = 0; index < array.length; index++) {
        ...
        let stationUrl  = window.location.origin+"/station/59513090d3fb43c5b62a963dd5189f7c";

        let winHtml =
          `<div style="width:120px;height: 1px;">`+
          `<div style="height:3px;width:100%;position:absolute;top:0;right:0;text-align: center;margin-top: 3%;"><a href="`+stationUrl+`">打开泵站管理</a></div>`+
          `</div>`;
    ...
    initwxMap() {
      ...
      this.map.centerAndZoom(new T.LngLat(112.569114,22.263770), 13);
      // this.map.centerAndZoom(new T.LngLat(112.573627,22.262488), 13);
