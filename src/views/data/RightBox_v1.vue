    ...
    <div class="topBox">
      ...
      <div style="float: left;width: 100%;height: 100%;">
        ...
        <div class="infoBox1">
          ...
          <el-col :span="20" class="tip1">清污机数量(个)</el-col>
          <el-col :span="12" class="tip2">{{obj.v8}}</el-col>
        </div>
        <div class="infoBox1">
          <img :src="img6" class="imgTip">
          <el-col :span="20" class="tip1">皮带机数量(个)</el-col>
          <el-col :span="12" class="tip2">{{obj.v9}}</el-col>
        </div>
      </div>
    </div>
    <div class="bottomBox">
      <div class="titleBox">
        <img :src="image1" class="leftImage">
        <div class="titleInfo">测流点统计信息</div>
        <img :src="image2" class="rightImage">
        <div class="titleTip"></div>
      </div>
