<template>
  <div class="MidBox">
    <div class="topBox">
      ...
      <div class="topInfo" v-if="false">
        <div class="tip1" v-if="false">同比去年上升：<span style="font-size: 26px;">{{obj.v1}}</span></div>
        <div class="tip2" v-if="false">闸开启总次数：<span style="font-size: 26px;">{{obj.v2}}</span></div>
        <div class="tip3" v-if="false">未开启站点：<span style="font-size: 26px;">{{obj.v3}}</span></div>
        <div class="bar1" v-if="false"></div>
        <div class="bar2" v-if="false"></div>
        <div class="bar3" v-if="false"></div>
      </div>
