  ...
  <el-main class="main" style="width: 88%;">
    <div  style="width: 100%;height: 100%;float: left;margin-left: 0px;"  v-loading="loading">
      <div class="" style="width: 28%;height: 100%;float: left;">
        <div style="width: 100%;background-color: white;border-radius: 5px;height: 70%;float: left;">
          <device4 :deviceId="deviceId"></device4>
<!--          <div class="tipBox">-->
...
export default {
  name: 'manage',
  components: { Device4, VideoControl, HeaderBox,LeftBox },
  data() {
    return {
      flvPlayer1: null,
      flvPlayer2: null,
