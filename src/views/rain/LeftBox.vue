      ...
      <el-col :span="24">
        <el-menu
          ...
          <el-submenu index="4"   v-if="checked4">
            ...
            <el-menu-item index="4-2"><router-link to="/rainMap"><div style="margin-left: 30px;font-size: 16px;">水雨情统计</div></router-link></el-menu-item>
            <el-menu-item index="4-1"><router-link to="/rainWater"><div style="margin-left: 30px;font-size: 16px;">水雨情明细</div></router-link></el-menu-item>
            <el-menu-item index="4-3"><router-link to="/rainDay"><div style="margin-left: 30px;font-size: 16px;">雨情日报表</div></router-link></el-menu-item>
            <el-menu-item index="4-4"><router-link to="/rainMonth"><div style="margin-left: 30px;font-size: 16px;">雨情月报表</div></router-link></el-menu-item>
            <el-menu-item index="4-5"><router-link to="/rainYear"><div style="margin-left: 30px;font-size: 16px;">雨情年报表</div></router-link></el-menu-item>
          </el-submenu>
        </el-menu>
      </el-col>
    </el-row>
