  ...
  <el-main class="main" style="width: 88%;">
    <div class="" style="width: 28%; height: 100%; float: left;">
      <div class="machineBox"  v-if="checkType===1">
        <device3 :deviceId="deviceId"></device3>
<!--        <div class="tipBox">-->
...
<!--        </div>-->
      ...
      <div class="machineBox"  v-if="checkType===2">
        <device1 :deviceId="deviceId"></device1>
<!--        <div class="tipBox">-->
<!--          <div style="width: 3px;height: 20px;background-color: #1E7AD8;float: left;"></div>-->
...
<!--        </div>-->
      ...
      <div class="machineBox"   v-if="checkType===3">
        <device2 :deviceId="deviceId"></device2>
<!--        <div class="tipBox">-->
<!--          <div style="width: 3px;height: 20px;background-color: #1E7AD8;float: left;"></div>-->
...
<!--        </div>-->
      ...
      <div style="width: 100%;height: calc( 30% - 20px);background-color: white;float: left;margin-top: 20px;border-radius: 5px;">
        <div class="tipBox">
          <div style="width: 3px;height: 20px;background-color: #1E7AD8;float: left;"></div>
...
import Device1 from '@/views/station/device1.vue'
import Device2 from '@/views/station/device2.vue'
import Device3 from '@/views/station/device3.vue'
import Device4 from '@/views/gate/device4.vue'
export default {
  name: 'manage',
  components: { Device4, Device3, Device2, Device1, VideoControl, HeaderBox,LeftBox },
  data() {
    return {
      date1:'',
      date2:'',
