  ...
  <div class="deviceBox">
    ...
    <div class="btnBox">
      <div class="info" >
        停止
        <div class="circleBox">
          <div class="circleSon" :style="{backgroundColor:(array3[0]===1)?'#F71515':'#C0C0C0'}"></div>
        </div>
      </div>
      <div class="info">
        运行
    ...
    <div class="softBox">
      <div class="detail" style="margin: 0">
        <el-col :span="10" style="margin-top: 5px;font-size: 16px;text-align: left;">软启动器状态：</el-col>
        <el-col :span="12" style="margin-top: 4px;font-size: 20px;color:#2B2D97;">正常停</el-col>
      </div>
    </div>
    <div class="runTimeBox">
      <div class="detail" style="margin: 6px 0px;">
...
export default {
  ...
  watch: {
    ...
    deviceId(newVal, oldVal) {
      ...
      if (newVal === '7f28017c77b846da9130303004ab5e42'){
        this.title = '2号电机'
      }else if (newVal === '051635b9aa4c47af935f71fb62828f42'){
        this.title = '4号电机'
      }else if (newVal === '74bd441aa7f44956926623007577ea71'){
        this.title = '3号电机'
      }else {
        this.title = '1号电机'
      }
  ...
  mounted() {
    ...
    this.getInfo('3f79a090a42c4eb4a1779892a46fc5ca')
    //this.getTime();
  ...
  methods:{
    ...
    setStatus(obj){
      ...
      if (obj.v4){//故障
        array[2] = parseInt(obj.v4)
      }
      if (obj.v5){//现地
        array[3] = parseInt(obj.v5)
      }
      if (obj.v6){//远控
